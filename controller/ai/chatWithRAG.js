...
const { generateRAGResponse } = require("../../services/professionalRAGService");
...
async function chatWithRAG(req, res) {
    try {
        ...
        const response = await generateRAGResponse(query, Product);
        ...
        console.log("🛍️ Products Recommended:", response.recommendedProducts?.length || 0);
        console.log("=".repeat(60) + "\n");
